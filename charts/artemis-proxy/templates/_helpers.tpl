...
Usage: 'name: "{{- template "artemis-proxy.name" . -}}"'
*/ -}}
{{- define "artemis-proxy.name"}}
...
The applied order is: "global prefix + prefix + name + suffix + global suffix"
Usage: 'name: "{{- template "artemis-proxy.fullname" . -}}"'
*/ -}}
{{- define "artemis-proxy.fullname"}}
